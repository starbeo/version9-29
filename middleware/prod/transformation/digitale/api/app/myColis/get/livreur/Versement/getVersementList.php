...
// query products
$stmt = $EtatColisLivrerMethods->GetAllversementListPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        $etatcolislivrer_item=array(
            "etat_colis_livre_id"  =>  $etat_colis_livre_id,
            "reference" =>  $name,
            "montant" =>  $total,
    ...
    $total_rows=$EtatColisLivrerMethods->nombreversement(isset($_GET['livreur_id']) ? $_GET['livreur_id'] : die());
    $page_url="{$home_url_livreur}Versement/getVersementList.php?livreur_id=".(int)$livreur_id."&tocken=$tocken&";
