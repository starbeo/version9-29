...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        extract($row);
        $facture_item=array(
            "virement_id" =>  $facture_id,
            "libelle" =>  'Virement reçu de la Facture : '.$nom,
            "montant" =>  $total_net,
    ...
    $page_url="{$home_url_client}Facture/getVirementList.php?client_id=".(int)$expediteur."&tocken=$tocken&";
