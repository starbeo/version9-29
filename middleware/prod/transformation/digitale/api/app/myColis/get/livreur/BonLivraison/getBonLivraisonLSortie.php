...
// query products
$stmt = $BonLivraisonMethods->GetAllBonLivraisonSortiePaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$BonLivraisonMethods->nombrebonlivraisonSortie(isset($_GET['livreur_id']) ? $_GET['livreur_id'] : die());
    $page_url="{$home_url_livreur}BonLivraison/getBonLivraisonLSortie.php?livreur_id=".(int)$livreur_id."&tocken=$tocken&";
