...
// query products
$stmt = $ColisMethods->GetAllColisretourneaLagnceByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisRetournerAlagence(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_client}Colis/getColisRetournerAlagence.php?client_id=".(int)$expediteur."&tocken=$tocken&";
