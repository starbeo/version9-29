...
// query products
$stmt = $ColisMethods->GetAllColisReporterByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisReporte(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_client}Colis/getColisReporter.php?client_id=".(int)$expediteur."&tocken=$tocken&";
