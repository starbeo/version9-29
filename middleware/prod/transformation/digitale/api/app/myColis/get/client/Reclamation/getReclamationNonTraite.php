...
// query products
$stmt = $ReclamationsMethods->GetAllReclamationNonTraiteByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ReclamationsMethods->nombrereclamationnontraite(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_client}Reclamation/getReclamationNonTraite.php?client_id=".(int)$expediteur."&tocken=$tocken&";
