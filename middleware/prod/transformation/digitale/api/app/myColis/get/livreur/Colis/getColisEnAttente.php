...
// query products
$stmt = $ColisMethods->GetAllColisEnAttenteByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisInAttente(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_livreur}Colis/getColisEnAttente.php?client_id=".(int)$expediteur."&tocken=$tocken&";
