...
// query products
$stmt = $FactureMethods->GetAllFacturesRetournerByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$FactureMethods->nombrefacturesRetourner(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_client}Facture/getFacturesRetourner.php?client_id=".(int)$expediteur."&tocken=$tocken&";
