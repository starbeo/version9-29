...
// query products
$stmt = $ColisMethods->GetAllColisInjoignableByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisInjoignable(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_client}Colis/getColisInjoignable.php?client_id=".(int)$expediteur."&tocken=$tocken&";
