...
// query products
$stmt = $ColisMethods->GetAllColisencoursByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisEncours(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_livreur}Colis/getColisEncours.php?client_id=".(int)$expediteur."&tocken=$tocken&";
