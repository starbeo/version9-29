...
// query products
$stmt = $ColisMethods->GetAllColisNumeroErronerByExpediteurPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisNumeroErroner(isset($_GET['client_id']) ? $_GET['client_id'] : die());
    $page_url="{$home_url_client}Colis/getColisNumeroErroner.php?client_id=".(int)$expediteur."&tocken=$tocken&";
