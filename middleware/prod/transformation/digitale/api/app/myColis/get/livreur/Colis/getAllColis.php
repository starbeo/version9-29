...
// query products
$stmt = $ColisMethods->GetAllColisPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisLivreur(isset($_GET['livreur_id']) ? $_GET['livreur_id'] : die());
    $page_url="{$home_url_livreur}Colis/getAllColis.php?livreur_id=".(int)$livreur_id."&tocken=$tocken&";
