...
// query products
$stmt = $ColisMethods->GetAllColisRamasserPaging($from_record_num, $records_per_page,
...
if($num>0){
    ...
    $total_rows=$ColisMethods->nombrecolisRamasser(isset($_GET['livreur_id']) ? $_GET['livreur_id'] : die());
    $page_url="{$home_url_livreur}Colis/getColisRamasser.php?livreur_id=".(int)$livreur_id."&tocken=$tocken&";
