...
$(document).ready(function () {
    ...
    $('body').on('change', 'select[id="_language"]', function () {
        ...
        window.location.href = poin_relais_url + 'home/change_language/' + value;
    });
    ...
    $('.notifications-icon-staffs').on('click', function () {
        $.post(poin_relais_url + 'misc/set_notifications_client_read').success(function (response) {
    ...
    $('#search_input').on('keyup paste', function () {
        ...
        delay(function () {
            ...
            $.post(point_relais_url + 'misc/search', {
                q: q
