							...
							<div class="col-md-8">
		                        <div class="btn-group pull-right" data-toggle="tooltip" title="Filtre journale d'activité">
									...
									<ul class="dropdown-menu" style="max-height: 400px; overflow: scroll;">
									    ...
									    <li>
									        <a href="#" onclick="dt_custom_view(<?= $client['id']; ?>,'.table-activity-log'); return false;">
									            <?= client_logo($client['id'],array('staff-profile-image-small-1','img-circle','pull-left')).' '.$client['nom']; ?>
									        </a>
									    </li>
									    <?php } ?>
									</ul>
				...
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php render_datatable(array(
							...
							_l('utility_activity_log_dt_client'),
							),'activity-log'); ?>
					</div>
				</div>
			</div>
...
<?php init_tail(); ?>
<!-- JS -->
<script src="<?= site_url('assets/js/admin/utilities/activity-log-customer.js?v=' . version_sources()); ?>"></script>
</body>
</html>
