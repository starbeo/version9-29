<?php $this->load->view('admin/authentication/' . get_option('theme_login_admin') . '/includes/head.php'); ?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 authentication-form-wrapper animated fadeIn">
                ...
                <div class="mtop40 authentication-form">
                    ...
                    <h3 class="text-center"><?= _l('administration_area'); ?></h3>
...
<?php $this->load->view('admin/authentication/' . get_option('theme_login_admin') . '/includes/scripts.php'); ?>
<!-- JS -->
<script src="<?= site_url('assets/js/authentication/' . get_option('theme_login_admin') . '/manage.js'); ?>"></script>
</html>
