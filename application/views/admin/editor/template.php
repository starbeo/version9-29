    ...
    ?>
      <div class="advanced-editor-wrapper<?= $editor_name; ?> _ql-editor">
        <div class="toolbar-container<?= $editor_name; ?>"><span class="ql-format-group">
        ...
        <div class="editor-container<?= $editor_name; ?>"></div>
        <textarea name="<?= $name; ?>" class="hide editor_change_contents<?= $editor_name; ?>"></textarea>
        <div class="editor_contents<?= $editor_name; ?> hide"><?= trim($contents); ?></div>
      </div>
