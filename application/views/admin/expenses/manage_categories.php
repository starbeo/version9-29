            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <a href="#" onclick="new_category();
                                return false;" class="btn btn-info pull-left display-block"><?= _l('new_expense_category'); ?></a>
                    </div>
                </div>
                <div class="panel_s">
                    <div class="panel-body">
...
<div class="modal fade" id="category" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?= form_open(admin_url('expenses/category')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?= _l('edit_expense_category'); ?></span>
                    <span class="add-title"><?= _l('new_expense_category'); ?></span>
                </h4>
            </div>
