...
$result  = data_tables_init($aColumns, $sIndexColumn, $sTable, array(), $id_E, array(), array('roleid'));
...
foreach ($rResult as $aRow) {
    ...
    //$options .= icon_btn('admin/roles/delete/' . $aRow['roleid'], 'remove', 'btn-danger _delete btn-delete-confirm');
    $row[]   = $options;
