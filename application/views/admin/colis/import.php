                ...
                foreach ($errors as $key => $value) {
                    if (!empty($value['num_commande']) || !empty($value['ville']) || !empty($value['crbt']) || !empty($value['phone']) || !empty($value['name']) || !empty($value['address'])) {
                        ...
                        if (!empty($value['num_commande'])) {
                            ...
                            $err .= "<i class='fa fa-exclamation-triangle' style='font-size:14px;color:red'></i>  Numéro de commande vide ou bien il existe déjà : <b>" . $value['num_commande'] . "</b>";
                        }
                        $erreur .= $err . '</p>';
                    }
                }
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-6 no-padding">
                            ...
                            <!--a href="<?= admin_url('villes/export') ?>" class="btn btn-info mright5"><?= _l('download_list_cities'); ?></a-->
                        </div>
                        <div class="col-md-6 no-padding">
                        ...
                        <div class="row">
                            <div class="col-md-4 mtop15">
                                ...
                                <?php $selected = (isset($clientid) ? $clientid : ''); ?>
                                <?= render_select('clientid', $clients, array('id', 'nom'), 'als_expediteur', $selected); ?>
...
<?php init_tail(); ?>
<!-- JS -->
<script src="<?= site_url('assets/js/admin/colis/import.js?v=' . version_sources()); ?>"></script>
</body>
</html>