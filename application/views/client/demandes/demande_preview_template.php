                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="pull-right">
                                ...
                                <a class="btn btn-default mright5" href="<?= client_url('demandes/demande/' . $demande->id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?= _l('edit_string'); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <?php } else if($demande->status == 4) { ?>
                                <a class="btn btn-success mright5" href="<?= client_url('demandes/demande/' . $demande->id); ?>" data-toggle="tooltip" data-placement="bottom" title="Donner une note"><i class="fa fa-star"></i></a>
                                <?php } ?>
                                <a class="btn btn-danger mright5" href="<?= client_url('demandes/delete/' . $demande->id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?= _l('delete'); ?>"><i class="fa fa-remove"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                ...
                                <?php } else if ($demande->departement_objet_bind_to == 'demandes') { ?>
                                    <?php $rels_id =  json_decode($demande->rels_id);  ?>
                                    <?php for($i = 0; $i<count($rels_id);$i++) { ?>
                           <?php  $demandss =get_demande($rels_id[$i], 'name'); ?>
                                        <a href="#" class="btn btn-info btn-icon" onclick="init_demande(<?= $rels_id[$i]; ?>);return false;">    <?= $demandss; ?> </a>
                                    <?php } ?>
                                <?php } ?>
                            </p>
                            <?php } ?>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_messages">
                    <div class="media">
                        <div class="media-left">
                            <?= client_logo(get_expediteur_user_id(), array('staff-profile-image-small mright5', 'media-object'), 'small', array('data-toggle' => 'tooltip', 'data-title' => get_client_full_name(), 'data-placement' => 'right')); ?>
                        </div>
