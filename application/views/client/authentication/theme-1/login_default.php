...
<body id="wallId" class="login_admin" style="background-image: url('<?= site_url(); ?>assets/images/background/fonds-ecran/big/<?= get_option('background_authentication_client'); ?>'); background-size: 100%;">
    <div class="container">
        <div class="row">
                ...
                <div class="mtop40 authentication-form">
                    ...
                    <div class="text-center mb10">
                        <?php if (!empty(get_option('website'))) { ?>
                            <?= icon_btn(get_option('website'), 'globe', 'btn-globe mright5', array('title' => _l('our_website'), 'target' => '_blank'), true); ?>
                        <?php } ?>
                    ...
                    <h3 class="text-center"><?= _l('client_area'); ?></h3>
            ...
            <div class="col-md-3">
                <div id="configuration" class="hide-configuration">
                    ...
                    <div id="containerWallId" class="containerWall">
                        ...
                        <img id="imageWall2" alt="image" onclick="changeWallpaper('login_bg_12.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_12.jpg'); ?>">
                        <img id="imageWall3" alt="image" onclick="changeWallpaper('login_bg_13.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_13.jpg'); ?>">
                        <img id="imageWall4" alt="image" onclick="changeWallpaper('login_bg_14.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_14.jpg'); ?>">
                        <img id="imageWall5" alt="image" onclick="changeWallpaper('login_bg_15.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_15.jpg'); ?>">
                        <img id="imageWall6" alt="image" onclick="changeWallpaper('login_bg_16.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_16.jpg'); ?>">
                        <img id="imageWall7" alt="image" onclick="changeWallpaper('login_bg_17.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_17.jpg'); ?>">
                        <img id="imageWall8" alt="image" onclick="changeWallpaper('login_bg_18.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_18.jpg'); ?>">
                        <img id="imageWall9" alt="image" onclick="changeWallpaper('login_bg_18.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_19.jpg'); ?>">
                        <img id="imageWal20" alt="image" onclick="changeWallpaper('login_bg_18.jpg')" src="<?= base_url('assets/images/background/fonds-ecran/small/login_bg_20.jpg'); ?>">
                    </div>
                </div>    
            </div>
        </div>
