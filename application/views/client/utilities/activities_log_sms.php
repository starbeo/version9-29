        ...
        <div class="row">
            ...
            <div id="filter-table" class="bloc-filter-table display-none">
                <div class="bloc-content-filter">
                    ...
                    <div id="filter-submit" class="btn btn-success width100p mbot5" data-table="activities-log-sms"><?= _l('filter'); ?></div>
                    <div id="filter-reset" class="btn btn-info width100p mbot5" data-table="activities-log-sms"><?= _l('reset'); ?></i></div>
...
<!-- JS -->
<script src="<?= site_url('assets/js/client/utilities/activities_log_sms.js?v=' . version_sources()); ?>"></script>
</body>
</html>
