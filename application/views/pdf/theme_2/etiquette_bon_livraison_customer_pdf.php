...
foreach ($bon_livraison->items as $key => $item) {
    ...
    $logo_html = '';
    if (!is_null($bon_livraison->client->logo)) {
        $url_logo = base_url_logo_client() . get_expediteur_user_id() . '/thumb_' . $bon_livraison->client->logo;
    ...
    $data .= "<div style='float: " . $float . "; width: 49.5%; height: 360px; margin-bottom: 5px; line-height: 10px;'>
                <div style='border: 1px dashed #000; width: 100%;'>
                    <div style='border-right: 1px solid #000; width: 49%; float: left; margin: 0;'>
                        ...
                        <p style='border-top: 2px solid #000; border-bottom: 2px solid #000; margin: 0 0 10px 0; padding: 5px; font-size: 13px; font-weight: bold; text-align: center;'>Destinataire</p>
                        <table style='width: 100%;'>
                            <tbody>
                                <tr>
    ...
    $data .= "              </tbody>
                    ...
                    <div style='width: 49%; margin: 0;'>
                        <p style='border-left: 1px solid #000; border-bottom: 2px solid #000; margin: 0 0 10px 0; padding: 5px; font-size: 15px; font-weight: bold; text-align: center;'>Commande</p>
