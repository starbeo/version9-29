    ...
    $data .= "<div style='float: ".$float."; width: 49.5%; height: 360px; margin-bottom: 5px; line-height: 10px;'>
                ...
                <div style='border: 1px dashed #000; width: 100%; '>
                    ...
                    <div style='width: 48%; margin: 0;'>
                        <p style='border-bottom: 2px solid #000; margin: 0; padding: 5px; font-size: 15px; font-weight: bold;'>Date d'expedition : ".$date_ramassage."</p>
                        ...
                        <p style='margin: 0; padding: 5px; text-align: center;'>
                            <img src='".site_url('assets/images/defaults/amana.png')."' style='width: 50%; height: 49px;'>
                        </p>
                    </div>
                </div>
              </div>";         
