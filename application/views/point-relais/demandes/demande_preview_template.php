                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="pull-right">
                                <?php if (is_numeric($demande->addedfrom) && $demande->addedfrom == get_staff_user_id()) { ?>
                                <a class="btn btn-default mright5" href="<?= point_relais_url('demandes/demande/' . $demande->id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?= _l('edit_string'); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                ...
                                <a href="<?= point_relais_url('colis/search/' . $barcode) ?>" target="_blank"><?= $barcode; ?></a>
                                <?php } else if ($demande->departement_objet_bind_to == 'factures') { ?>
                                <b><?= get_facture($demande->rel_id, 'nom'); ?></b>
                                <?php } ?>
                            </p>
                            <?php } ?>
