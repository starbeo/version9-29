            ...
            <div class="col-md-offset-3 col-md-6">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <a href="<?= point_relais_url('demandes/demande'); ?>" class="btn btn-success pull-right mbot20 display-block"><?= _l('new_request'); ?></a>
                        ...
                        <?= render_select('rel_id', array(), array(), 'relation', '', array(), array('id' => 'relation'), 'display-none'); ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-right">
                                        <a href="<?= point_relais_url('demandes/remove_attached_piece_demande/' . $demande->id); ?>" title="Supprimer pièce jointe"><i class="fa fa-remove"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
...
<!-- JS -->
<script src="<?= site_url('assets/js/point-relais/demandes/demande.js?v=' . version_sources()); ?>"></script>
</body>
</html>
