<div id="header">
    ...
    <a id="logo" href="<?= site_url('point_relais'); ?>">
        ...
        <div class="mobile-menu">
            ...
            <div class="mobile-navbar collapse" id="mobile-collapse" aria-expanded="false" style="height: 0px;" role="navigation" >
                <ul class="nav navbar-nav">
                    <li><a href="<?= point_relais_url('profile/edit'); ?>"><?= _l('nav_edit_profile'); ?></a></li>
                    <li><a href="<?= site_url(); ?>authentication/logout_point_relais"><?= _l('nav_logout'); ?></a></li>
                </ul>
            </div>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu animated fadeIn">
                        <li>
                            <a href="<?= point_relais_url('profile/edit'); ?>"><?= _l('nav_edit_profile'); ?></a>
                        </li>
                        <li>
                            <a href="<?= site_url(); ?>authentication/logout_point_relais"><?= _l('nav_logout'); ?></a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    <?php
                    $unread_notifications = total_rows('tblnotifications', array('touserid' => get_staff_user_id(),  'isread' => 0), 100);
