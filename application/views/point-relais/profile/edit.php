        ...
        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-right">
                                        <a href="<?= point_relais_url('profile/remove_staff_profile_image'); ?>"><i class="fa fa-remove"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
            ...
            <div class="col-md-6">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        <?= form_open('point_relais/profile/change_password_profile', array('id' => 'staff_password_change_form')); ?>
                        <div class="form-group">
...
<!-- JS -->
<script src="<?= site_url('assets/js/point-relais/profile/edit.js?v=' . version_sources()); ?>"></script>
</body>
</html>
